...
class Constants {
  static final mainBackgroundColor = Color(0xFF1A73E8);
  static final backgroundColor = Color(0xFFE4EFFF);
...
/*  static final whitetextcolor = Color(0xFFFFFFFF);
  ...
  static final buttonPrimary = Color(0xff1a73e8) ;
  ...
  static final primary = Color(0xFF005FA4);
...
/*  static final backgroundColor = Color(0x29292929);
  ...
  static final shadowColor = Color(0x19000000);
